...
public class GRPC_Client {
    ...
    public static void displayMenu() throws InterruptedException {
        ...
        System.out.println("Type 1 to register as a new user: ");
        System.out.println("Type 2 to login to an existing User Account");
        System.out.println("Type 3 to create a User Profile");
        System.out.println("Type 4 to update User Profile");
        System.out.println("Type 5 to Stop Program");
    ...
    private static void createProfile(userGrpc.userStub userStub, Scanner scanner) {
        ...
        String username = scanner.nextLine();
        System.out.print("Set your full-name: ");
        String fullName = scanner.nextLine();
        System.out.print("Set your e-mail address?: ");
        ...
        StreamObserver<User.ProfileResponse> responseObserver = new StreamObserver<User.ProfileResponse>() {
            ...
            public void onCompleted() {
                logger.info("Congratulations! Your profile has been created successfully.");
            }
        };
